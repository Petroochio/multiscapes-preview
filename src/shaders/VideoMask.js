...
const matHoles = `
  ...
  void main() {
    ...
    if (t0 >= threshold && t0 < 1.0) {
      color.a = color.a - ((1.0-t0)/(1.0-threshold))*((1.0-t0)/(1.0-threshold));
    }
    if (t1 >= threshold && t1 < 1.0) {
      color.a = color.a - ((1.0-t1)/(1.0-threshold))*((1.0-t1)/(1.0-threshold));
    }
    if (t2 >= threshold && t2 < 1.0) {
      color.a = color.a - ((1.0-t2)/(1.0-threshold))*((1.0-t2)/(1.0-threshold));
    }
    if (t3 >= threshold && t3 < 1.0) {
      color.a = color.a - ((1.0-t3)/(1.0-threshold))*((1.0-t3)/(1.0-threshold));
    }
    if (t4 >= threshold && t4 < 1.0) {
      color.a = color.a - ((1.0-t4)/(1.0-threshold))*((1.0-t4)/(1.0-threshold));
    }
    if (t5 >= threshold && t5 < 1.0) {
      color.a = color.a - ((1.0-t5)/(1.0-threshold))*((1.0-t5)/(1.0-threshold));
    }
    if (t6 >= threshold && t6 < 1.0) {
      color.a = color.a - ((1.0-t6)/(1.0-threshold))*((1.0-t6)/(1.0-threshold));
    }
    if (t7 >= threshold && t7 < 1.0) {
      color.a = color.a - ((1.0-t7)/(1.0-threshold))*((1.0-t7)/(1.0-threshold));
    }
    if (t8 >= threshold && t8 < 1.0) {
      color.a = color.a - ((1.0-t8)/(1.0-threshold))*((1.0-t8)/(1.0-threshold));
    }
    if (t9 >= threshold && t9 < 1.0) {
      color.a = color.a - ((1.0-t9)/(1.0-threshold))*((1.0-t9)/(1.0-threshold));
    }
    if (t10 >= threshold && t10 < 1.0) {
      color.a = color.a - ((1.0-t10)/(1.0-threshold))*((1.0-t10)/(1.0-threshold));
    }
    if (t11 >= threshold && t11 < 1.0) {
      color.a = color.a - ((1.0-t11)/(1.0-threshold))*((1.0-t11)/(1.0-threshold));
    }
    if (t12 >= threshold && t12 < 1.0) {
      color.a = color.a - ((1.0-t12)/(1.0-threshold))*((1.0-t12)/(1.0-threshold));
    }
    if (t13 >= threshold && t13 < 1.0) {
      color.a = color.a - ((1.0-t13)/(1.0-threshold))*((1.0-t13)/(1.0-threshold));
    }
    if (t14 >= threshold && t14 < 1.0) {
      color.a = color.a - ((1.0-t14)/(1.0-threshold))*((1.0-t14)/(1.0-threshold));
    }
    if (t15 >= threshold && t15 < 1.0) {
      color.a = color.a - ((1.0-t15)/(1.0-threshold))*((1.0-t15)/(1.0-threshold));
    }
